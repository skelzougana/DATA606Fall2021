...
Each raw represents a data collected from an individual in a the survey.
...
antWeekdays = numerical- discrete 
...
Population = children between the age of 5 and 15.   Sample = 160 children
...
The result of the study can't be generalised because there is a bias in the instruction given to the two group of children.
The finding can be used to establish causal relationship.
...
Yes. The result is practically significant, more importantly the risk increases with the amount of cigarettes smoked per day
...
The statement is not justified. The conclusion that can be drawn from the study is that there is higher probability for those children who have behavioral problem to have sleep disorders sypmtoms.
...
Exercice on mental health. The control groups are exercising group and the non exercising group.


(c) Does this study make use of blocking? If so, what is the blocking variable?
There is no blocking in this study.
...
Yes, the result can be used to establish causal relationship between excercice and mental health.The conclusion can be generalised to the population at large.

(f) Suppose you are given the task of determining if this proposed study should get funding. Would you have any reservations about the study proposal?
It has a practical significance, it is worth funding.
